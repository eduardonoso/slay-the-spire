...
var UPGRADE_DATABASE = {
  ...
  cleave: { name: 'Cleave+', description: 'Deal 12 damage to ALL.', effects: [{ type: 'damageAll', value: 12 }] },
  ...
  battle_trance: { name: 'Battle Trance+', description: 'Draw 4 cards. You cannot draw additional cards this turn.', effects: [{ type: 'drawCards', value: 4 }, { type: 'setFlag', flag: 'noDraw' }] },
